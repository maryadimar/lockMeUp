	        ...
	        <!-- timeline time label -->
	          ...
	          <div>
	            ...
	            <div class="timeline-item">
	              ...
	              <h3 class="timeline-header">{{ $value->created_at->diffForHumans() }} - <strong>{{ $value->bagian }}</strong></h3>
