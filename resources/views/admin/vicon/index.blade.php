      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="float-right">
            <a href="/admin/booking/create-vicon-pribadi" class="btn btn-primary" >Booking Pribadi</a> <a href="/admin/booking/create-vicon" class="btn btn-primary" >Booking Vicon</a>
          </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  @if(!empty($value->meeting_id))
                    {{ $value->meeting_id }} (Host)
                  @else
                    {{ $value->meeting_idl }} (Join)
                  @endif
                </td>
                <td>{!! nl2br($value->agenda) !!}</td>
                <td>{{ $value->pics }}</td>
                <td><a href="/admin/booking/{{ $value->id }}/detailvicon" class="btn-action btn btn-primary"><i class=" fa fa-eye"></i></a> <a href="/admin/booking/{{ $value->id }}/delete" class="btn-action btn btn-danger" Onclick="return ConfirmDelete();"><i class=" fa fa-trash"></i></a></td>
              </tr>
            @endforeach
