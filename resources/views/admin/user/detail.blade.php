                       ...
                       <ul class="nav flex-column">
                         <li class="nav-item">
                           <a href="#" class="nav-link">
                             PN <span class="float-right"><input type="text" id="pn" name="pn" readonly="" class="float-right" style="width: 100%;"></span>
                           </a>
                         </li>
                         <li class="nav-item">
                           <a href="#" class="nav-link">
                         ...
                         <li class="nav-item">
                           <a href="#" class="nav-link">
                             Bagian <span class="float-right"><input type="text" id="bagian" name="bagian" readonly="" class="float-right" style="width: 100%;"></span>
                           </a>
                         </li>
                       </ul>
                     </div>
