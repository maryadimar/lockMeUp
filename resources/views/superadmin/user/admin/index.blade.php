...
@section('content')
  <div class="row">
    <div class="col-md-2">
      ...
      @include('superadmin.user.admin.detail')
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" id="quickForm" method="POST" action="/sa/admin/save">
                @csrf
...
<script type="text/javascript">
  ...
  function active(e){
    ...
    swal({
      ...
      text: "Anda Yakin Mengaktikan Admin Ini?",
      type: 'success',
  ...
  function nonactive(e) {
    ...
    swal({
      ...
      text: "Anda Yakin Menonaktikan Admin Ini?",
      type: 'success',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
