  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Booking Vicon</h4>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group ukur">
                    ...
                    <select class="form-control select2bs4" name="bagian" id="bagian" required>
                      @foreach ($bagians as $bagian) 
                        <option>{{ $bagian->nama_bagian }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group ukur">
                    ...
                    <select class="form-control select2bs4" name="r_meeting" id="r_meeting" required>
                      ...
                      <option value="Lantai 10 (1)">Lantai 10 (1)</option>
                      <option value="Lantai 10 (2)">Lantai 10 (2)</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                      <input type="text" name="tanggal" id="tanggal" class="form-control datetimepicker-input" data-target="#datetimepicker4" required/>
