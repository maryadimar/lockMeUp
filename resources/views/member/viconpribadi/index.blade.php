...
@section('titleheader')
  <h1>
    <a href="/user/vicon-pribadi-create" class="btn btn-primary">Booking Vicon Pribadi</a>
          ...
          <div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-body">
                ...
                <strong class="text-danger"> Peserta Cabang </strong> : <br> 
                  {!! nl2br($value->peserta_cabang) !!} <br>
                <strong class="text-danger"> Peserta Orang </strong> : <br> 
                  {!! nl2br($value->peserta_orang) !!} <br>
                ...
                <strong class="text-danger">Tanggal</strong>: <br> {{ $value->tanggal }} <br>
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  <address>
                    <strong class="text-danger">Email</strong> : <br> {!! nl2br($value->email) !!} <br>
                ...
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  <strong class="text-danger">PIC</strong> : <br> {!! nl2br($value->pic) !!} <br>
                  <strong class="text-danger">No Surat</strong> : <br> {!! nl2br($value->no_surat) !!} <br>
                  <strong class="text-danger">Kontak</strong> : <br> {!! nl2br($value->nohp) !!} 
                </div>
                <!-- /.col -->
              </div>
              </div>
              ...
              <div class="timeline-footer">
                ...
                <a class="btn btn-danger btn-sm" href="/user/vicon-pribadi/{{ $value->id }}/delete" onclick="return deleteConfirmation()">Delete</a>
