...
@section('titleheader')
  <h1>
    <a href="/user/vicon-create" class="btn btn-primary">Booking Vicon</a>
          ...
          <div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-footer">
                ...
                <a class="btn btn-danger btn-sm" href="/user/vicon/{{ $value->id }}/delete" onclick="return deleteConfirmation()">Delete</a>
